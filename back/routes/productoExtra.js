...
router.get("/:id_producto", [param("id_producto").isInt().withMessage("ID inválido")], validarErrores, getAllExtrasByProducto);
...
router.delete("/:id_producto/:nombre", [param("id_producto").isInt().withMessage("ID inválido"), param("nombre").notEmpty().withMessage("El nombre es obligatorio")], validarErrores, deleteProductoExtra);
